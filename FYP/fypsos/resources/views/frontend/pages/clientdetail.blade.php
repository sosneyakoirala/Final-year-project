    ...
    <body>
             ...
             <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                   <div class="right-sideabr">
                      <div class="inner-box">
                         ...
                         <input type="hidden" name="lat" class="form-control" id="lat" size=12 value="{{$client->lat}}">
                         
                         <input type="hidden" name="lon" class="form-control" id="lon" size=12 value="{{$client->lon}}">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                   <div class="job-alerts-item">
                      <h3 class="alerts-title">Client Detail</h3>
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-3">
                                <span class="location"><i class="ti-location-pin"></i>
                                    @foreach ($cities->where('id','=',$client->city) as $city)
                                    {{$city->name}}
                      ...
                      {{-- <div class="alerts-content">
                         <form action="{{route('rating.store')}}" method="POST">
                            ...
                            <div class="row">
                               <div class="col-md-6">
                                  <input type="hidden" name="worker_id" value="{{$client->id}}" >
       ...
       <script type="text/javascript">
          // New York
          var startlat = {{$client->lat}};
          // {{Auth::user()->latitude}}
          var startlon = {{$client->lon}};
          // {{Auth::user()->longitude}}
