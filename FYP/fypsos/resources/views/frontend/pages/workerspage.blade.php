            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="breadcrumb-wrapper">
                     <h2 class="product-title">Browse Worker</h2>
                     <ol class="breadcrumb">
                        <li><a href="/"><i class="ti-home"></i> Home</a></li>
                        <li class="current">Browse Worker</li>
                     </ol>
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-9 col-sm-8">
                  ...
                  <div class="job-list">
                     <div class="thumb">
                        ...
                        @foreach ($avgrating->where('worker_id','=',$w->id) as $rating)
                        {{-- <span><i class="ti-star" style="color: rgb(241, 107, 107);"></i>{{$rating->rating}}</span> --}}
                        @php
                        ...
                        <div class="star">
                           @for($i=1; $i<=5; $i++)
                           @if($rate>=$i)
                           <i class="fa fa-star" style="color: rgb(241, 107, 107);"></i>
                           @else
                        ...
                        <div class="job-tag">
                           <div class="pull-left">
                              <div class="meta-tag">
                                 ...
                                 {{-- <span><i class="ti-star"></i>60/Hour</span> --}}
                              </div>
                           </div>
                  ...
                  <div class="job-list">
                     <div class="thumb">
                        ...
                        @foreach ($avgrating2->where('worker_id','=',$w2->id) as $rating)
                        {{-- <span><i class="ti-star" style="color: rgb(241, 107, 107);"></i>{{$rating->rating}}</span> --}}
                        @php
                        $rate=ceil($rating->rating)
                        @endphp
